                    ...
                    return (
                      ...
                      >
                        ...
                        <td className='px-2 py-1.5 text-right'>
                          {disc.pct > 0 ? (
                            <span className='text-gray-400 line-through'>
                              {formatUnitPriceEuro(displayUnitHt(item))}
                            </span>
                          ) : (
                            <span>
                              {formatUnitPriceEuro(displayUnitHt(item))}
                        ...
                        <td className='px-2 py-1.5 text-right'>
                          {disc.pct > 0 ? (
                            <span className='text-gray-400 line-through'>
                              {formatUnitPriceEuro(displayUnitTtc(item))}
                            </span>
                          ) : (
                            <span>
                              {formatUnitPriceEuro(displayUnitTtc(item))}
                      ...
                      return (
                        ...
                        >
                          <td className='px-2 py-1.5'>
                            ...
                            {disc.pct > 0 && (
                              <span className='block text-[9px] text-red-600'>
                                {l.discount} -{formatEuroDecimal(disc.amount)}{' '}
                                HT
                              </span>
                            )}
                          </td>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className='px-2 py-1.5 text-right'>
                            {disc.pct > 0 ? (
                              <span className='text-gray-400 line-through'>
                                {formatUnitPriceEuro(displayUnitHt(extra))}
                              </span>
                            ) : (
                              <span>
                                {formatUnitPriceEuro(displayUnitHt(extra))}
                          ...
                          <td className='px-2 py-1.5 text-right'>
                            {disc.pct > 0 ? (
                              <span className='text-gray-400 line-through'>
                                {formatUnitPriceEuro(displayUnitTtc(extra))}
                              </span>
                            ) : (
                              <span>
                                {formatUnitPriceEuro(displayUnitTtc(extra))}
