    ...
    try {
      ...
      const rolesToCreate = [
        ...
        },
        {
          ...
          slug: 'commercial',
          description:
            'Gestion des contacts et réservations de ses restaurants',
          is_default: true,
        },
        {
          organization_id: organization.id,
          ...
          slug: 'gerant',
          description:
            'Accès aux événements de son/ses restaurant(s) uniquement',
          is_default: true,
        },
      ]
      ...
      if (allPermissions && allPermissions.length > 0) {
        ...
        if (commercialRole) {
          perms
            .filter((p) => commercialPerms.includes(p.slug))
            .forEach((p) =>
              rolePermsToInsert.push({
        ...
        if (gerantRole) {
          perms
            .filter((p) => gerantPerms.includes(p.slug))
            .forEach((p) =>
              rolePermsToInsert.push({
        ...
        await supabase
          ...
          .insert(rolePermsToInsert as never)
      }
      ...
      const defaultStatuses = [
        ...
        {
          name: 'Confirmé / Fonction à faire',
          slug: 'confirme',
          color: '#22c55e',
          type: 'contact',
          position: 5,
        ...
        {
          name: 'Fonction envoyée',
          slug: 'fonction_envoyee',
          color: '#14b8a6',
          type: 'contact',
          position: 6,
        },
        ...
        {
          name: 'Attente paiement',
          slug: 'attente_paiement',
          color: '#8b5cf6',
          type: 'contact',
          position: 8,
        },
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <p className='text-xs text-muted-foreground'>
                            Utilisé dans l'URL : mealevent.com/
                            <strong>{field.value || 'mon-groupe'}</strong>
                          </p>
                          <FormMessage />
                        </FormItem>
                      )}
          ...
          {currentStep === 3 && (
            <>
              <CardHeader className='text-center'>
                ...
                <CardDescription>
                  Votre organisation a été créée avec succès. Vous pouvez
                  maintenant commencer à utiliser MealEvent.
                </CardDescription>
              </CardHeader>
              <CardContent>
