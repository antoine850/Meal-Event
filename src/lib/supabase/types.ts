  ...
  public: {
    Tables: {
      ...
      email_template_restaurants: {
        ...
        Relationships: [
          {
            foreignKeyName: "email_template_restaurants_restaurant_id_fkey"
            columns: ["restaurant_id"]
            isOneToOne: false
            referencedRelation: "restaurants"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "email_template_restaurants_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
      ...
      user_gmail_accounts: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_gmail_accounts_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_gmail_accounts_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "users"
            referencedColumns: ["id"]
