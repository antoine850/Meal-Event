...
// Remplace roundLineTtc/computeQuoteTotals (ceil-euro). Cf. note client Foolish Studio (29/06/2026) :
...
// Totaux du devis (remise en pied) : sous-total = somme des lignes, puis remise globale appliquee
